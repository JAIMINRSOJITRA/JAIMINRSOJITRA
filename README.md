...
Building AI/ML projects for fun — LLM agents, prediction models, and automation experiments.

## 🔭 What I'm into

- 🤖 LLM-powered agents (research assistants, meeting-notes-to-tasks tools)
- 📊 Machine learning prediction projects (loan approval, house price, stock market, spam detection)
- 🌱 AI applications for real-world problems (smart waste reduction)
...
Check out my [portfolio](https://github.com/JAIMINRSOJITRA/portfolio) or explore my [repositories](https://github.com/JAIMINRSOJITRA?tab=repositories).

---
⭐️ From [JAIMINRSOJITRA](https://github.com/JAIMINRSOJITRA)
